...
import com.example.llantasdebicicleta.databinding.BiciHibridaBinding

class BiciHibrida : AppCompatActivity() {

    private lateinit var binding: BiciHibridaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = BiciHibridaBinding.inflate(layoutInflater)
        ...
        val spinnerTamanoLlanta: Spinner = findViewById(R.id.spinner_tamano_llanta2)
        ...
        val adapter = ArrayAdapter(this,
            R.layout.spinner_item, resources.getStringArray(R.array.tamanos_llantas_array2))
    ...
    private fun updateTotalPrice() {
        ...
        priceText.text = "Precio Total:  $$totalPrice"
    }
}