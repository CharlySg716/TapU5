...
import com.example.llantasdebicicleta.databinding.BiciMontanaBinding

class BiciMontana : AppCompatActivity() {

    private lateinit var binding: BiciMontanaBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = BiciMontanaBinding.inflate(layoutInflater)
        ...
        val adapter = ArrayAdapter(this,
            R.layout.spinner_item, resources.getStringArray(R.array.tamanos_llantas_array))
